...
public class ClientBook extends JFrame implements ActionListener, KeyListener {
   ...
   private void handleCreateRoomButtonClick() {
      ...
      while (!createRoom) {
         ...
         createRoom = !isRoomNameDuplicate(room_name);
      }
   ...
   private void recv_Msg(String str) {            //11-22
