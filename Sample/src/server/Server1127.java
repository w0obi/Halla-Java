...
public class Server1127 extends JFrame implements ActionListener {
   ...
   public void initializeGUI() {
      setTitle("Server1127 Application");
   ...
   private void startServer() { // 11-13
      try {
         ...
         textArea.append("Server1127 started on port: " + port + "\n");
   ...
   private void stopServer() { // 11-21
      try {
         if (ss != null && !ss.isClosed()) {
            ss.close();
            textArea.append("Server1127 stopped.\n");
         }
      } catch (IOException e) {
